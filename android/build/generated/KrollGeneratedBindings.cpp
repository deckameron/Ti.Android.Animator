...
namespace titanium {
	namespace bindings {
		...
		class AnimatorBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* AnimatorBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.android.animator.AnimatorModule", ::ti::android::animator::AnimatorModule::bindProxy, ::ti::android::animator::AnimatorModule::dispose}
			};
